...
export class BuildingFactory {
    ...
    public constructor() {
        this.buildingPrototypeMap.set(BuildingTypeEnum.LUMBER_CAMP, new BuildingPrototype(BuildingTypeEnum.LUMBER_CAMP.toString(), BuildingTypeEnum.LUMBER_CAMP,
            RessourceTypeEnum.WOOD, 5, RessourceTypeEnum.WOOD, 0, RessourceFactory.getInstance().getPrototype(RessourceTypeEnum.WOOD).cloneWithSpecificQuantity(5)));
        this.buildingPrototypeMap.set(BuildingTypeEnum.LUMBER_MILL, new BuildingPrototype(BuildingTypeEnum.LUMBER_MILL.toString(), BuildingTypeEnum.LUMBER_MILL,
            RessourceTypeEnum.PLANK, 1, RessourceTypeEnum.WOOD, 5, RessourceFactory.getInstance().getPrototype(RessourceTypeEnum.WOOD).cloneWithSpecificQuantity(20)));
        this.buildingPrototypeMap.set(BuildingTypeEnum.STONE_QUARRY, new BuildingPrototype(BuildingTypeEnum.STONE_QUARRY.toString(), BuildingTypeEnum.STONE_QUARRY,
            RessourceTypeEnum.STONE, 1, RessourceTypeEnum.STONE, 0, RessourceFactory.getInstance().getPrototype(RessourceTypeEnum.PLANK).cloneWithSpecificQuantity(5)));
    }
